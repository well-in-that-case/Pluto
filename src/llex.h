...
enum RESERVED {
  ...
  /* New compatible keywords */
  TK_PSWITCH, TK_PCASE, TK_PDEFAULT, TK_PCONTINUE, TK_PWHEN, TK_PSTRICT,
  ...
  TK_WHEN,
#endif
#ifndef PLUTO_COMPATIBLE_STRICT
  TK_STRICT,
#endif
...
[[noreturn]] LUAI_FUNC void luaX_error (LexState *ls, const char *s, int token = 0);
